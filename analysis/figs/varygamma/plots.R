...
h5file <- file.path(base_dir, "pseudogp-paper/data/monocle_vary_gamma_traces.h5")
repfile <- file.path(base_dir, "pseudogp-paper/data/trapnell_embeddings.h5")
