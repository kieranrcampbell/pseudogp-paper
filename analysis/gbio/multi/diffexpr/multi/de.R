...
##--------------- Edit here
tracefile <- paste0(base_dir, "GP/pseudogp2/data/monocle_multi_traces.h5")
h5outputfile <- paste0(base_dir, "GP/pseudogp2/data/multi_diffexpr/monocle_diffexpr.h5")
##--------------- End edit


pst <- h5read(tracefile, "multi/pst")
