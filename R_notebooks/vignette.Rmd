...
base_dir <- "~/mount"
setwd(file.path(base_dir, "GP/pseudogp2/R_notebooks"))
```
...
h5file <- file.path(base_dir, "/GP/pseudogp2/data/embeddings.h5")
h5createFile(h5file)
h5createGroup(h5file, "monocle")
h5write(redDim(sce_23), h5file, "monocle/X")
