...
outputfile <- paste0(base_dir, "GP/pseudogp2/stan/gbio/varygamma/diffexpr/g1.pdf")
h5file <- paste0(base_dir, "GP/pseudogp2/data/varygamma/g1.hdf5")
pstfile <- paste0(base_dir, "GP/pseudogp2/data/varygamma_traces.h5")

fdrfile <- paste0(base_dir, "GP/pseudogp2/stan/gbio/multi/diffexpr/g1.txt")
