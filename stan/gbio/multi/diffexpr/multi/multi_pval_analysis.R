...
## Edit 'waterfall' here ------
outputfile <- paste0(base_dir, "GP/pseudogp2/stan/gbio/multi/diffexpr/multi/all_plots.pdf")
h5file <- paste0(base_dir, "GP/pseudogp2/data/multi_diffexpr/monocle_diffexpr.h5")
pstfile <- paste0(base_dir, "GP/pseudogp2/data/monocle_multi_traces.h5")

fdrfile <- paste0(base_dir, "GP/pseudogp2/stan/gbio/multi/diffexpr/multi_fdr.txt")
