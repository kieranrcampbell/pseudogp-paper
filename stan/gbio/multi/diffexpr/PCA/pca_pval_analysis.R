...
## Edit 'waterfall' here ------
outputfile <- paste0(base_dir, "GP/pseudogp2/stan/gbio/multi/diffexpr/PCA/all_plots.pdf")
h5file <- paste0(base_dir, "GP/pseudogp2/data/multi_diffexpr/PCA_diffexpr.h5")
pstfile <- paste0(base_dir, "GP/pseudogp2/data/monocle_multi_traces.h5")

fdrfile <- paste0(base_dir, "GP/pseudogp2/stan/gbio/multi/diffexpr/pca_fdr.txt")
...
pst <- h5read(pstfile, "indv/g2/pst")
